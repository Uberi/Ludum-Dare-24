...
;plant1 := new seaweed(1,board.width,board.height -150)
;plant2 := new seaweed(2,board.width - 200,board.height -150)
;plant3 := new seaweed(3,board.width + 300,board.height -150)
;plant4 := new seaweed(4,board.width / 2,board.height -150)
...
plant2 := new sprite(board.width * .7,board.height *.8,board.height * .1, board.width * .1,1,0,64,64,64)
plant3 := new sprite(board.width * .5,board.height *.8,board.height * .1, board.width * .1,1,0,64,64,64)
plant4 := new sprite(board.width * .3,board.height *.8,board.height * .1, board.width * .1,1,0,64,64,64)
